...
// specs
test('should pretty compile .styl to .css', async t => {
...
test('should ignore unless .styl file', async t => {
...
test('should compress if specify opts.compress is true', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
    contents: basicFixture
  }), [
...
test('should import fixture.styl if specify opts.import', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
    contents: new Buffer('')
  }), [
...
test('should import fixture.styl using @import', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
...
test('should include paths if specify opts.include', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
...
test('should load plugin if specify opts.use', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
    contents: new Buffer(`
      body
...
test('should load plugin if dynamic first argument with options', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
    contents: new Buffer(`
      body
...
test('should enable variable if specify opts.define', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
    contents: basicFixture
  }), [{
...
test('should enable variable if using gulp-data', async t => {
  const file = new File({
    path: 'dummy.styl',
    contents: basicFixture
  })
...
test('should enable raw-variable if specify opts.rawDefine', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
...
test('should resolve url if specify opts[`resolve url`]', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
...
test('should resolve url with nocheck if specify opts[`resolve url nocheck`]', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
...
test('should convert url to datauri if specify opts.urlfunc', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
    contents: new Buffer(`
      body
...
test('should convert url to datauri if specify opts.urlfunc at object/array', async t => {
  const [left, right] = await pluginTest(new File({
    path: 'dummy.styl',
    contents: new Buffer(`
      body
...
test('should export stylus reference', t => {
